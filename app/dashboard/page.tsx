...
import { Package, Truck, Receipt, RotateCcw, TrendingUp, XCircle, Ban, Eye, Filter, X } from 'lucide-react';
  ...
  return (
    <Box>
      ...
      <Card p={{ base: 4, md: 6 }} mb={{ base: 4, md: 6 }}>
        ...
        >
          <FormControl flex={{ base: '1 1 100%', md: '1 1 250px' }}>
            <FormLabel fontSize="sm" fontWeight="medium" mb={2}>Date</FormLabel>
            <Input
              type="date"
              value={dateFilter}
          ...
          <FormControl flex={{ base: '1 1 100%', md: '1 1 250px' }}>
            <FormLabel fontSize="sm" fontWeight="medium" mb={2}>Type de la date</FormLabel>
